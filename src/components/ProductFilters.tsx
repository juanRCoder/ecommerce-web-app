  ...
  return (
    <section className='mt-3'>
      ...
      <div 
        ...
        className='cursor-pointer select-none relative rounded-[5px] outline outline-[#29292930] text-[#292929] flex justify-between px-3 py-2'
      >
        ...
        {openCategory && (
          <div className='absolute top-full mt-2 left-0 rounded-[5px] w-full outline outline-[#29292930] text-[#292929] flex flex-col bg-white z-50'>
            <span 
              onClick={() => handleSelectCategory('')}
              className='p-3 py-2 cursor-pointer hover:bg-[#20857233]'
            >
              Todos
            </span>
      ...
      <div className='flex gap-3 max-[250px]:flex-col'>
